		...
		return(
			...
			<Item key='{game.id}'>
      			<Item.Content>
        			...
        			<Container text>
        			<br/>
          				<p>&emsp; <strong>This app is designed to give PC game enthusiasts a source for their favorite games at the lowest price available. We take the tediuos task of searching many sites online so our users can focus on having fun. </strong></p>
